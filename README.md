...
Статус бэкенда компиляции:

1. [x] Интерпретатор со своей виртуальной машиной TigerVM
2. [ ] Компилятор для .NET (_в процессе разработки_)
...
* Поддержка объявлений типов
* Поддержка массивов
* Поддержка структур
* Поддержка nil для структур
