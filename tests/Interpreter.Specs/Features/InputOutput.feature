...
Функциональность: ввод-вывод и завершение программы
    ...
    Сценарий: вывов функции flush
        Пусть я загрузил программу "features/input_output/print_string_with_flush.tig"
    ...
    Сценарий: завершение из программы функцией exit с ненулевым кодом
        Пусть я загрузил программу "features/input_output/exit_with_non_zero_code.tig"
