...
public class FunctionsTests
{
    ...
    public static TheoryData<string, string> GetEvaluateFunctionsData()
    {
        return new TheoryData<string, string>
        {
            ...
            // Функция с нетривиальной реализацией
            {
                """
