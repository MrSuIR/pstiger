...
30. `StoreResult` устанавливает результат работы программы
    - Снимает значение со стека вычислений, используя его как результат работы программы (произвольное значение)
31. `Halt` останавливает работу программы
    - Снимает значение со стека вычислений, используя его как целочисленный код возврата
32. `PushVars [Index]` добавляет новую таблицу переменных, дочернюю по отношению к указанной таблице переменных
...
33. `PopVars` убирает текущую таблицу переменных, заменяя её на родительскую таблицу переменных
